Feature: Data Health Check for Most Vdps Report
  ...
  Scenario: C321578 Verify that all column is sortable for Last 7 days
    ...
    And I click sort from Carfax rank from Most VDPs
    ...
    And I click sort from Carfax Pulls from Most VDPs

  Scenario: Verify that cargurus rank from Most VDPs should have data
    Then cargurus rank from Most VDPs should have data

  Scenario: Verify that AutoTrader rank from Most VDPs should have data
    Then AutoTrader rank from Most VDPs should have data

  Scenario: Verify that CarsDotCom rank from Most VDPs should have data
    Then CarsDotCom rank from Most VDPs should have data

  Scenario: Verify that Carfax rank from Most VDPs should have data
    Then Carfax rank from Most VDPs should have data

  Scenario: Verify that Price from Most VDPs should have data
    Then Price from Most VDPs should have data

  Scenario: Verify that Default Percent of Market from Most VDPs should have data
    Then Default Percent of Market from Most VDPs should have data

  Scenario: Verify that DOL from Most VDPs should have data
    Then DOL from Most VDPs should have data

  Scenario: Verify that Photos from Most VDPs should have data
    Then Photos from Most VDPs should have data

  Scenario: Verify that Most VDPs from Most VDPs should have data
    Then Leads from Most VDPs should have data

  Scenario: Verify that Vdps from Most VDPs should have data
    Then Vdps from Most VDPs should have data

  Scenario: Verify that Most VDPs and Vdps from Most VDPs should have data
    Then Leads and Vdps from Most VDPs should have data

  Scenario: Verify that Carfax Pulls from Most VDPs should have data
  ...
  Scenario: Verify that Leads from Most VDPs should have data
    Then Leads from Most VDPs should have data
