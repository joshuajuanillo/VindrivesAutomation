...
public class ChannelStatReportStepsDefinition {
    ...
    public void iClickTwiceTheSortByFunctionInSRPColumnAndDataAreNotUnknownFromChannelStatReport() throws InterruptedException {
        ...
        WebElement cargurusSort =  Utility.driver.findElement(By.xpath(ChannelStatReport.autotraderSrpSort));
        actions.moveToElement(cargurusSort).perform();
        cargurusSort.click();
        ...
        Utility.driver.findElement(By.xpath(ChannelStatReport.autotraderSrpSort)).click();
        Thread.sleep(5000);
    ...
    public void iClickTwiceTheSortByFunctionInVDPColumnAndDataAreNotUnknownFromChannelStatReportWebsite() throws InterruptedException {
        ...
        WebElement cargurusSort =  Utility.driver.findElement(By.xpath(ChannelStatReport.gaWebsite));
        actions.moveToElement(cargurusSort).perform();
        cargurusSort.click();
        ...
        Utility.driver.findElement(By.xpath(ChannelStatReport.gaWebsite)).click();
        Thread.sleep(5000);
