...
With Test Plan
trcli -y -h https://revdojo.testrail.io --project "Revdojo" --username "joshua@revdojo.com" --password "Jjuanillo1396@" parse_junit --title "Auction Direct USA Rochester" --plan-id 608 --run-id 614 --case-matcher "name" -f "./target/vindrivesTestRun.xml"