...
With Test Plan
trcli -y -h https://revdojo.testrail.io --project "Revdojo" --username "joshua@revdojo.com" --password "Jjuanillo1396@" parse_junit --title "Demo Client" --plan-id 550 --run-id 551 --case-matcher "name" -f "./target/vindrivesTestRun.xml"