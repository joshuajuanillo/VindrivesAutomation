...
With Test Plan
trcli -y -h https://revdojo.testrail.io --project "Revdojo" --username "joshua@revdojo.com" --password "Jjuanillo1396@" parse_junit --title "Demo Client" --plan-id 664 --run-id 665 --case-matcher "name" -f "./target/vindrivesTestRun.xml"